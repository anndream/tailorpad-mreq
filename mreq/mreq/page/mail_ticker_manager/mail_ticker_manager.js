frappe.pages['mail-ticker-manager'].onload = function(wrapper) {
...
erpnext.AccountsChart = Class.extend({
	init: function(ctype, purpose, wrapper, mail_to, from_date, to_date) {
		...
		this.tree = new frappe.ui.Tree({
			...
			method: 'mreq.mreq.page.mail_ticker_manager.mail_ticker_manager.get_children',
			click: function(link) {
				// bold
...
erpnext.Template = Class.extend({
	...
	set_email_body: function(template_name){
		var me = this;
		frappe.call({
			method: 'mreq.mreq.page.mail_ticker_manager.mail_ticker_manager.get_email_body',
	...
	manage_mail_ticker: function(purpose){
		...
		frappe.call({
			method: 'mreq.mreq.page.mail_ticker_manager.mail_ticker_manager.manage_mail_ticker',
